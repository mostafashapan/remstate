...
const Navbar = () => {
  return (
    <nav
      className="w-full bg-gray-50 border-b border-gray-200 sticky top-0 z-50"
      aria-label="Progress steps navigation"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center space-x-4 overflow-x-auto no-scrollbar py-4">
