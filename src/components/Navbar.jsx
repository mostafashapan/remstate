  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-center space-x-0 sm:space-x-3 overflow-x-auto no-scrollbar py-3 sm:py-4 scroll-smooth snap-x">
